...
<b>Наши клиенты</b>
<ul>
<li><a href="interface_admin_nb_8.php">Список задач</a></li>
...
<form method="post" action="interface_admin_nb_8.php" name="form1">
...
<b>Мастера</b>
<ul>
<li><a href="master_zp_8.php">Зарплаты мастеров</a></li>
</ul>

<b>Статистика</b>
<ul>
<li><a href="stat_8.php">Статистика</a></li>
</ul>
</div>

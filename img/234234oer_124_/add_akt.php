...
<body style="margin-top:15px;background:white;">
	...
	<tr>
	<td style="padding-top:15px;">
		<h1 style="color:black;font-weight:normal;margin-top:25px;margin-bottom:20px;font-family:Arial;font-size:18pt;text-align:center;">Просьба порекомендовать нас своим друзьям и знакомым</h1>
	</td>
	</tr>	
	
	<tr>
	<td style="padding-top:5px;">
		<h1 style="color:black;font-weight:normal;margin-top:25px;margin-bottom:20px;font-family:Arial;font-size:18pt;text-align:center;float:left">Визитка для друга</h1>
		<h1 style="color:black;font-weight:normal;margin-top:25px;margin-bottom:20px;font-family:Arial;font-size:18pt;text-align:center;float:right">Визитка для знакомого</h1>
	</td>
	</tr>	
	</table>
